...
func Ulid(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func CreateUserID(v int) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UlidEQ(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUlid), v))
	})
}
...
func UlidNEQ(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UlidIn(vs ...string) predicate.Team {
...
func UlidNotIn(vs ...string) predicate.Team {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UlidGT(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UlidGTE(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UlidLT(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UlidLTE(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UlidContains(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UlidHasPrefix(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UlidHasSuffix(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UlidEqualFold(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func UlidContainsFold(v string) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func CreateUserIDEQ(v int) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCreateUserID), v))
	})
}
...
func CreateUserIDNEQ(v int) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
...
func CreateUserIDIn(vs ...int) predicate.Team {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreateUserIDNotIn(vs ...int) predicate.Team {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
// HasCreateUser applies the HasEdge predicate on the "create_user" edge.
func HasCreateUser() predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(CreateUserTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, CreateUserTable, CreateUserColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasCreateUserWith applies the HasEdge predicate on the "create_user" edge with a given conditions (other predicates).
func HasCreateUserWith(preds ...predicate.User) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(CreateUserInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, CreateUserTable, CreateUserColumn),
		)
...
func HasTeamUsers() predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTeamUsersWith(preds ...predicate.TeamUser) predicate.Team {
	return predicate.Team(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
