...
// NotFoundError returns when trying to fetch a specific model and it was not found in the database.
...
// NotSingularError returns when trying to fetch a singular model and more then one was found in the database.
