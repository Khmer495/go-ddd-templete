...
type Auth struct {
	...
	// FirebaseUserID holds the value of the "firebase_user_id" field.
	...
	for i := range columns {
		...
		case auth.FieldFirebaseUserID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field firebase_user_id", values[i])
			} else if value.Valid {
				a.FirebaseUserID = value.String
			}
		}
	}
	return nil
...
func (a *Auth) String() string {
	...
	builder.WriteString(", firebase_user_id=")
	builder.WriteString(a.FirebaseUserID)
	builder.WriteByte(')')
