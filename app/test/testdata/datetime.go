...
func init() {
	model.TimeNowFunc = func() time.Time {
...
var Datetime0, _ = model.NewDatetime(Datetime0Time)
...
var JstDatetime0, _ = model.NewDatetime(JstDatetime0Time)
var Datetime1Time time.Time = time.Date(2020, 4, 1, 12, 34, 56, 0, time.UTC)
var Datetime1, _ = model.NewDatetime(Datetime1Time)

// Datetime0の1年前
var Datetime2Time time.Time = time.Date(2005, 1, 2, 15, 4, 5, 0, time.UTC)
var Datetime2, _ = model.NewDatetime(Datetime2Time)
